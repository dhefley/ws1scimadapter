...
module.exports.Schemas = {
  "Resources":
    [
      ...
      {
        "id": "urn:ietf:params:scim:schemas:extension:scimgateway:2.0:User",
        "name": "ScimGateway Custom Attributes",
        "description": "Schema for Scimgateway custom attributes",
        "attributes": [
          {
            "name": "immutableId",
            "type": "string",
            "multiValued": false,
            "description": "Source anchor representing user object in Azure Active Directory",
            "required": false,
            "caseExact": false,
            "mutability": "readWrite",
            "returned": "default",
          ...
          },
          {
            ...
            "type": "string",
            "multiValued": false,
            "description": "Custom attribute string",
            "required": false,
            "caseExact": false,
            "mutability": "readWrite",
            "returned": "default",
        ...
        "meta": {
          "resourceType": "Schema",
          "location":
            "/v2/Schemas/urn:ietf:params:scim:schemas:extension:scimgateway:2.0:User"
        }
      },
      {
